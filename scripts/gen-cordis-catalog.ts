...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ExecutorStartRequest: 'resolved executor request is owned by packages/core/executor/README.md',
  HarnessProfile: 'project profile policy record is owned by packages/core/profile/README.md',
  ProfileRegistration: 'profile registration handle is owned by packages/core/profile/README.md',
