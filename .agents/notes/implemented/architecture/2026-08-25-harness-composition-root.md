...
Adding `packages/composition` to the boundary gate means this layer can never quietly acquire a project dependency; the reuse-evidence suite already fails on that class of drift and now covers one more root.
